...
const SKILL_ICONS = {
  ...
  JavaScript: (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="#F7DF1E">
      ...
      <path d="M13.2 18.6c.4.7 1 .9 1.8.9.8 0 1.3-.4 1.3-1 0-.7-.6-1-1.5-1.4l-.5-.2c-1.4-.6-2.3-1.4-2.3-3.1 0-1.5 1.2-2.7 3-2.7 1.3 0 2.3.5 2.9 1.7l-1.6 1c-.3-.5-.7-.7-1.2-.7-.6 0-.9.3-.9.8 0 .6.3.8 1.2 1.2l.5.2c1.7.7 2.6 1.5 2.6 3.3 0 1.9-1.5 2.9-3.5 2.9-2 0-3.2-.9-3.9-2.1zM7.6 18.8c.3.6.6 1 .9 1 .3 0 .5-.1.5-.7v-7.7h2.2V19c0 1.8-1.1 2.6-2.6 2.6-1.4 0-2.2-.7-2.7-1.6z" fill="#111827" />
    </svg>
  ),
  'C++': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M12 2 3.5 7v10L12 22l8.5-5V7z" fill="#00599C" />
      <path d="M10.2 15.7c-2 0-3.4-1.5-3.4-3.7 0-2.2 1.4-3.7 3.4-3.7 1.4 0 2.3.7 2.9 1.7l-1.3.8c-.3-.5-.8-.9-1.6-.9-1.1 0-1.9.9-1.9 2.1 0 1.2.8 2.1 1.9 2.1.8 0 1.3-.4 1.6-.9l1.3.8c-.6 1.1-1.5 1.7-2.9 1.7zM14.3 12.9h1v-1h1v-1h-1v-1h-1v1h-1v1h1zM18.3 12.9h1v-1h1v-1h-1v-1h-1v1h-1v1h1z" fill="#fff" />
    </svg>
  ),
  Java: (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M7.2 16.8c0 1.6 2.2 2.5 4.8 2.5 2.6 0 4.8-.9 4.8-2.5 0-1.2-1.3-1.8-2.8-2.1.9.6 1.4 1.1 1.4 1.7 0 .9-1.6 1.4-3.4 1.4s-3.4-.5-3.4-1.4c0-.6.5-1.1 1.4-1.7-1.5.3-2.8.9-2.8 2.1z" fill="#1565C0" />
      <path d="M12 6.2c.8-.7 1.1-1.3.8-2-.5.6-1.1 1-1.4 1.5-.4.7 0 1.4.6 2 .8.6 1.7 1.3.9 2.6 1.6-1 2.4-2 1.7-3.2-.3-.4-.8-.7-1.2-.9-.6-.4-.9-.6-1.4-1.1z" fill="#EF5350" />
      <path d="M6.5 20.5h11a.8.8 0 0 0 0-1.6h-11a.8.8 0 0 0 0 1.6z" fill="#6D4C41" />
    </svg>
  ),
  Vercel: (
...
export default function Home() {
  ...
  const skills = [
    ...
    { name: 'Java', icon: SKILL_ICONS['Java'] },
    { name: 'Vercel', icon: SKILL_ICONS['Vercel'] },
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '100px 24px 80px', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginTop: 20 }}>
            ...
            {[
              ...
              },
              {
                ...
                desc: 'Curated mentorship content, and built live judging dashboards.',
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section style={{ marginBottom: 56 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              { logo: '🏫', name: 'Kendriya Vidyalaya', degree: '12th pass', period: '2024' },
              { logo: '🎓', name: 'AKTU University', degree: 'B.Tech Computer Science', period: '2024 – 2028' },
              { logo: '📚', name: 'Learning Cybersecurity', degree: '', period: '2025' },
            ].map((edu, i) => (
              <div
                key={i}
                className="work-item"
        ...
        <footer style={{ borderTop: '1px solid #27272a', paddingTop: 48 }}>
          <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', gap: 48 }}>
              <div>
                ...
                { name: 'LinkedIn', url: 'https://linkedin.com/in/rixhavraj' },
                { name: 'GitHub', url: 'https://github.com/rixhavraj' },
                { name: 'Instagram', url: 'https://instagram.com/rixhavraj'},
              {name: 'Buy Me a Chai', url: 'https://buymeachai.ezee.li/rixhavraj'}].map(link => (
                  <div key={link.name} style={{ marginBottom: 8 }}>
                    <a href={link.url} target='_blank' rel='noopener noreferrer' style={{ color: '#a1a1aa', fontSize: 14, textDecoration: 'none' }}
                      onMouseEnter={e => e.currentTarget.style.color = '#fafafa'}
          ...
          <p style={{ marginTop: 48, fontSize: 12, color: '#52525b' }}>
            ...
            <a href="#" style={{ color: '#71717a', textDecoration: 'underline' }}>NaughtyKid</a>
          </p>
        </footer>
      </div>
