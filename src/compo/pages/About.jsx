...
const About= ()=> {
  return (
    ...
    <section className="relative flex flex-col md:flex-row items-center justify-center min-h-screen bg-amber-50">
        ...
        <div className="hidden md:flex flex-col space-y-4 items-center justify-center p-4 bg-amber-100">
        ...
        <div className="relative flex-1 p-8 md:p-16 lg:p-24 text-center md:text-left">
          <div className="max-w-xl mx-auto md:mx-0">
            ...
            <p className="text-gray-600 mb-8">
              I am a Freelancer skilled in web development with react and tailwindcss and experienced with wordpress.
            </p>
